...
import time
import statistics
fs= [1000000, 2000000, 4000000, 6000000, 10000000, 12000000]
...
for a in fs:
    ...
    for fc in range (40000, 200000, 20000):
        ...
        with open('pomiary_21_02/pomiar{}_fs{}_LO500MHz_med_1.txt'.format(fc,sdr.sample_rate), 'w') as plik:
        # Zapisz dane do pliku
            for element in wyniki_med:
                plik.write(str(element) + '\n')
        
        with open('pomiary_21_02/pomiar{}_fs{}_LO500MHz_sr_1.txt'.format(fc,sdr.sample_rate), 'w') as plik:
        # Zapisz dane do pliku
