...
#Dane do wykresu
moc =-40     # Moc sygnału
fg=400020000 # Częstotliwość ustawiona na generatorze
...
#Podział odebranych danych na kanał 1 i 0
        ...
        if tabela0[0] < tabela1[0] :
            ...
            for j in range(min(len(tabela0)),len(tabela1)) :
...
plt.grid()
plt.savefig('sym_24.svg', format='svg')
plt.show()

with open('sym_24.txt', 'w') as plik:
