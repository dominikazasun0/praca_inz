...
plt.title('Metod z aproksymacją - fg={}, fs={},\nmoc={}, faza=zmiana o 1° od 0° do 45° na chan2'.format(fg, sdr.sample_rate, moc))
plt.xlabel("Iteracja odbioru próbek")
plt.ylabel("Różnica fazy [°]")
plt.savefig('sym_18.svg', format='svg')
plt.grid()
plt.show()


with open('rsym_18.txt', 'w') as plik:
